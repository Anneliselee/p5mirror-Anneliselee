...
// https://editor.p5js.org/jeeyeonr/sketches/Hyy5W3GiQ

// Galaxy
// https://editor.p5js.org/makeea/sketches/S2EbH1g0M
// https://editor.p5js.org/jorge_droide/sketches/-q0zCTeHC
// More tutorials and sketches on my github page
...
function setup() {
  ...
  //make webcam video size of screen and hide
...
function draw() {
  ...
  if (detectionScore > 0) {
    ...
    fill(255, 255, 255, 60);
    ellipse(noseX, noseY, size/2, size/2);
